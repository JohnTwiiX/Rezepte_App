...
import { getStorage } from './RecipeScreen/Overview';
import { ScrollView as GHScrollView } from 'react-native-gesture-handler';
import Icon from 'react-native-vector-icons/MaterialCommunityIcons';

export default function RecipeMaxDrawer({ recipes, handleCrow }) {
                    ...
                    <View key={index}>
                        ...
                        <View style={{ flexDirection: 'row', padding: 8 }}>
                            ...
                            <View style={{ width: '50%', maxHeight: 300 }}>
                                <GHScrollView>
                                    <Text style={{ fontSize: 18 }} key={index}>{recipes.description.preparation[item.title]}</Text>
                                </GHScrollView>
                            </View>
                        </View>
                    </View>
